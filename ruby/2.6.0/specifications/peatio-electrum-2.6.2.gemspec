# -*- encoding: utf-8 -*-
# stub: peatio-electrum 2.6.2 ruby lib

Gem::Specification.new do |s|
  s.name = "peatio-electrum".freeze
  s.version = "2.6.2"
  ...
  s.authors = ["Camille Meulien".freeze]
  s.bindir = "exe".freeze
  s.date = "2020-06-10"
  s.description = "Peatio Plugin for Electrum server".freeze
  s.email = ["cmeulien@heliostech.fr".freeze]
  s.homepage = "https://www.openware.com".freeze
  s.rubygems_version = "3.0.8".freeze
  s.summary = "Peatio Plugin for Electrum server".freeze
