# -*- encoding: utf-8 -*-
# stub: peatio-litecoin 2.6.1 ruby lib

Gem::Specification.new do |s|
  s.name = "peatio-litecoin".freeze
  s.version = "2.6.1"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["Yaroslav S.".freeze]
  s.bindir = "exe".freeze
  s.date = "2020-06-10"
  s.description = "Litecoin Peatio gem which implements Peatio::Blockchain::Abstract & Peatio::Wallet::Abstract.".freeze
  s.email = ["ysavchuk@heliostech.fr".freeze]
  s.homepage = "https://openware.com/".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "3.0.8".freeze
  s.summary = "Gem for extending Peatio plugable system with Litecoin implementation.".freeze
